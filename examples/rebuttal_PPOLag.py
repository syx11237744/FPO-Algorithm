...
from omnisafe.utils.visualizer import extract_training_data_with_type, get_statistics, normalize_by, ENVTITLES
...
# extract_training_data_with_type(envs, ['PPOLag'], tags)
...
with open(os.path.join(RESULT_PATH, 'PPOLag.md'), 'w') as f:
    f.write('\n'.join(markdown_lines))
